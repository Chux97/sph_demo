  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        >
          <li>
            <img :src="detail.imgUrl" style="width: 90px; height: 90px" />
          </li>
          <li>
            <p>{{ detail.skuName }}</p>
            <h4>7天无理由退货</h4>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        consignee: this.defaultUser.consignee, //收件人姓名
        consigneeTel: this.defaultUser.phoneNum,  // 电话
        deliveryAddress:this.defaultUser.fullAddress, //地址
